...
echo "
###################################################################
# EXECUTANDO EXEMPLO PARA CRIAÇÃO DE CREDENCIAIS GLOBAIS POR XML  #
###################################################################
"
...
#source jenkins_api_folder_create_credentials_by_xml_string.sh
...
#source jenkins_api_folder_update_credentials_by_xml_string.sh
